...
| status            | String  |          |                              | please refer to [deposit status](#deposit-status) |
| txHash            | String  |          |                              |                                                   |
...
| status        | String  |          | chain status, Active Or Suspend |      |
...
```
GET /phemex-withdraw/wallets/api/withdrawHist/currency=<currency>&chainName=<chainNameList>&offset=<offset>&limit=<>&withCount=<>
```
...
| Parameter | Type    | Required | Description                  | Case      |
|-----------|---------|----------|------------------------------|-----------|
| currency  | String  | NO       |                              | USDT, ETH |
| chainName | List    | NO       |                              | ETH,TRX   |
| offset    | Long    | NO       | default 0                    |           |
| limit     | Integer | NO       | default 20                   |           |
| withCount | Boolean | NO       | Total conditional rows found |           |
...
```
POST /phemex-withdraw/wallets/api/createWithdraw/currency=<currency>&offset=<offset>&limit=<>&withCount=<>
```
...
|-----------|--------------|----------|-----------------|---------|
| currency  | String       | NO       | coin name       | ETH     |
| chainName | List<String> | NO       | chain name list | ETH,TRX |
| offset    | Long         | NO       | default 0       | 0       |
| limit     | Integer      | NO       | default 20      |         |
| withCount | Boolean      | NO       | default false   |         |
...
| userId       | Long      | YES      |                                    |                                                     |
| status       | String    |          |                                    | please refer to [withdraw status](#withdraw-status) |
...
```
POST /phemex-deposit/wallets/api/depositHist/id=<id>
```
...
|-----------|--------|----------|--------------------------|------|
| currency  | String | NO       | coin name                | ETH  |
| amount    | String | NO       | withdraw amount with fee | 0.1  |
...
| allAvailableBalanceRv      | String  | YES      | total balance minus locked trading balance, <br/>locked withdraw balance and frozen balance |                |
| chainCode                  | Integer | YES      | chain code                                                                                  |                |
| chainName                  | String  | YES      | chain name                                                                                  |                |
